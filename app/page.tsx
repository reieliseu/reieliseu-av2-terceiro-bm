...
export default function Page() {
  ...
  return <main className="min-h-screen bg-background text-foreground lg:grid lg:grid-cols-[0.9fr_1.1fr]">
    <section className="relative hidden overflow-hidden bg-primary p-12 text-primary-foreground lg:flex lg:flex-col lg:justify-between"><div><div className="mb-20 flex items-center gap-3"><div className="grid size-10 place-items-center rounded-xl bg-primary-foreground text-primary"><LockKeyhole /></div><span className="font-mono text-sm font-bold tracking-widest">SECUREFLOW</span></div><div className="max-w-lg"><p className="mb-5 font-mono text-xs uppercase tracking-[0.3em] text-primary-foreground/60">Projeto prático · DSW</p><h1 className="text-balance text-6xl font-semibold leading-[1.02] tracking-tight">Autenticação que <span className="text-primary-foreground/60">protege</span> cada acesso.</h1><p className="mt-7 max-w-md text-lg leading-relaxed text-primary-foreground/70">Uma plataforma acadêmica para demonstrar o fluxo completo entre React, Axios e uma API segura.</p></div></div><div className="grid grid-cols-2 gap-8 border-t border-primary-foreground/20 pt-7 text-sm"><div><ShieldCheck className="mb-3" /><strong className="block">JWT + bcrypt</strong><span className="text-primary-foreground/60">Sessões protegidas</span></div><div><CheckCircle2 className="mb-3" /><strong className="block">Rotas privadas</strong><span className="text-primary-foreground/60">Controle de acesso</span></div></div></section>
    <section className="flex min-h-screen items-center justify-center p-6 sm:p-12"><div className="w-full max-w-md"><div className="mb-10 lg:hidden"><div className="mb-8 flex items-center gap-3"><div className="grid size-10 place-items-center rounded-xl bg-primary text-primary-foreground"><LockKeyhole /></div><span className="font-mono text-sm font-bold tracking-widest">SECUREFLOW</span></div></div>
